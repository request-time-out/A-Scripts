...
namespace Studio
{
  public class FrameList : MonoBehaviour
  {
    ...
    public void UpdateUI()
    {
      ...
      this.select = this.listPath.FindIndex((Predicate<string>) (v => v == Singleton<Studio.Studio>.Instance.sceneInfo.frame));
    ...
    private void InitList()
    {
      ...
      string[] files = Directory.GetFiles(UserData.Create("frame"), "*.png");
      ...
      // ISSUE: reference to a compiler-generated field
      Func<string, string> fMgCache0 = FrameList.\u003C\u003Ef__mg\u0024cache0;
    ...
    private void CreateNode(int _idx, string _text)
    {
      ...
      FrameList.\u003CCreateNode\u003Ec__AnonStorey0 nodeCAnonStorey0 = new FrameList.\u003CCreateNode\u003Ec__AnonStorey0();
      // ISSUE: reference to a compiler-generated field
