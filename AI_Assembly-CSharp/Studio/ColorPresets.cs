...
namespace Studio
{
  ...
  {
    private ColorPresets.ColorInfo colorInfo;
    ...
    private void Awake()
    {
      ...
      if (Object.op_Implicit((Object) this.objNew))
      {
    ...
    private void Start()
    {
      ...
      if (Object.op_Inequality((Object) null, (Object) this.btnDelete))
      {
        ObservableExtensions.Subscribe<Unit>((IObservable<M0>) UnityUIComponentExtensions.OnClickAsObservable(this.btnDelete), (Action<M0>) (_ => this.SetPreset(true)));
        ((UnityEngine.Component) this.btnDelete).get_gameObject().SetActiveIfDifferent(5 != this.colorInfo.select);
      }
      for (int index = 0; index < this.tglFile.Length; ++index)
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: method pointer
        ((UnityEvent<bool>) this.tglFile[index].onValueChanged).AddListener(new UnityAction<bool>((object) new ColorPresets.\u003CStart\u003Ec__AnonStorey0()
        {
          \u0024this = this,
          no = index
        }, __methodptr(\u003C\u003Em__0)));
    ...
    {
      if (!Object.op_Implicit((Object) this.objNew) || !Object.op_Implicit((Object) this.imgNew))
        return;
    ...
    public void AddNewPreset(Color addColor, bool load = false)
    {
      ...
      ColorPresets.\u003CAddNewPreset\u003Ec__AnonStorey2 presetCAnonStorey2 = new ColorPresets.\u003CAddNewPreset\u003Ec__AnonStorey2();
      ...
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      ColorPresets.\u003CAddNewPreset\u003Ec__AnonStorey1 presetCAnonStorey1 = new ColorPresets.\u003CAddNewPreset\u003Ec__AnonStorey1();
      // ISSUE: reference to a compiler-generated field
      ...
      this.objNew.get_transform().SetSiblingIndex(90);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      if (Object.op_Implicit((Object) presetCAnonStorey1.cpi.image))
      {
        // ISSUE: reference to a compiler-generated field
      ...
      mouseButtonCheck1.buttonType = MouseButtonCheck.ButtonType.Right;
      // ISSUE: method pointer
      ...
      {
        // ISSUE: reference to a compiler-generated field
        UI_OnMouseOverMessage component = (UI_OnMouseOverMessage) presetCAnonStorey2.addObj.GetComponent<UI_OnMouseOverMessage>();
        if (Object.op_Implicit((Object) component))
    ...
    public void LoadPresets()
    {
      ...
      if (!File.Exists(path))
        return;
      this.colorInfo = (ColorPresets.ColorInfo) JsonUtility.FromJson<ColorPresets.ColorInfo>(File.ReadAllText(path));
    }
