...
namespace Studio
{
  public class BGMControl : MonoBehaviour
  {
    ...
    {
      Singleton<Studio.Studio>.Instance.bgmCtrl.repeat = Singleton<Studio.Studio>.Instance.bgmCtrl.repeat != BGMCtrl.Repeat.None ? BGMCtrl.Repeat.None : BGMCtrl.Repeat.All;
    ...
    {
      Singleton<Studio.Studio>.Instance.bgmCtrl.Play();
    }

    private void OnClickPause()
    {
      Singleton<Studio.Studio>.Instance.bgmCtrl.Pause();
    }
    ...
    private void Update()
    {
      ((Behaviour) this.imagePlayNow).set_enabled(Singleton<Studio.Studio>.Instance.bgmCtrl.play);
    }
  }
}
