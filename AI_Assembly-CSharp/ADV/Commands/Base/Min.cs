...
namespace ADV.Commands.Base
{
  public class Min : CommandBase
  {
    ...
    public override void Do()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      Func<string, float> fMgCache0 = Min.\u003C\u003Ef__mg\u0024cache0;
      this.scenario.Vars[this.answer] = new ValData((object) Mathf.Min(((IEnumerable<string>) argToSplitLast).Select<string, float>(fMgCache0).ToArray<float>()));
    }
  }
}
