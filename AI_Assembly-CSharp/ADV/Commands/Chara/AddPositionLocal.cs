...
// Type: ADV.Commands.Chara.AddPositionLocal
...
namespace ADV.Commands.Chara
{
  public class AddPositionLocal : CommandBase
  {
    ...
    public override void Do()
    {
      ...
      transform.set_localPosition(Vector3.op_Addition(transform.get_localPosition(), pos1));
      Vector3 pos2;
      if (!this.scenario.commandController.GetV3Dic(this.args.SafeGet<string>(cnt), out pos2))
        ...
        CommandBase.CountAddV3(ref cnt);
      transform.set_localEulerAngles(Vector3.op_Addition(transform.get_localEulerAngles(), pos2));
    }
  }
}
