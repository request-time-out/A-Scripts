...
namespace Rewired.UI.ControlMapper
{
  ...
  public class CustomButton : Button, ICustomSelectable, ICancelHandler, IEventSystemHandler
  {
    ...
    public virtual Selectable FindSelectableOnLeft()
    {
      ...
      return (((Navigation) ref navigation).get_mode() & 1) != null || this._autoNavLeft ? UISelectionUtility.FindNextSelectable((Selectable) this, ((Component) this).get_transform(), Selectable.get_allSelectables(), Vector3.get_left()) : ((Selectable) this).FindSelectableOnLeft();
    }

    public virtual Selectable FindSelectableOnRight()
    {
      Navigation navigation = ((Selectable) this).get_navigation();
      return (((Navigation) ref navigation).get_mode() & 1) != null || this._autoNavRight ? UISelectionUtility.FindNextSelectable((Selectable) this, ((Component) this).get_transform(), Selectable.get_allSelectables(), Vector3.get_right()) : ((Selectable) this).FindSelectableOnRight();
    }

    public virtual Selectable FindSelectableOnUp()
    {
      Navigation navigation = ((Selectable) this).get_navigation();
      return (((Navigation) ref navigation).get_mode() & 2) != null || this._autoNavUp ? UISelectionUtility.FindNextSelectable((Selectable) this, ((Component) this).get_transform(), Selectable.get_allSelectables(), Vector3.get_up()) : ((Selectable) this).FindSelectableOnUp();
    }
    ...
    private void Press()
    {
      if (!((UIBehaviour) this).IsActive() || !((Selectable) this).IsInteractable())
        return;
      ((UnityEvent) this.get_onClick()).Invoke();
    }

    public virtual void OnPointerClick(PointerEventData eventData)
    {
      if (!((UIBehaviour) this).IsActive() || !((Selectable) this).IsInteractable() || eventData.get_button() != null)
        return;
      this.Press();
      if (((UIBehaviour) this).IsActive() && ((Selectable) this).IsInteractable())
        return;
    ...
    public virtual void OnSubmit(BaseEventData eventData)
    {
      ...
      {
        ((Selectable) this).DoStateTransition((Selectable.SelectionState) 2, false);
        ((MonoBehaviour) this).StartCoroutine(this.OnFinishSubmit());
      }
    }
    ...
    private IEnumerator OnFinishSubmit()
    {
      ...
      return (IEnumerator) new CustomButton.\u003COnFinishSubmit\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
