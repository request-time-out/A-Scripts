...
public class TypefaceAnimatorEx : BaseMeshEffect
{
  ...
  private Func<float> animationTime;
  ...
  public float progress
  {
    ...
    set
    {
      ...
      if (!Object.op_Inequality((Object) this, (Object) null) || !Object.op_Inequality((Object) this.get_graphic(), (Object) null))
        return;
  ...
  {
    return Singleton<Game>.IsInstance() ? Singleton<Game>.Instance.StartCoroutine(routine) : ((MonoBehaviour) this).StartCoroutine(routine);
  }
  ...
  private IEnumerator WaitPlay()
  {
    ...
    return (IEnumerator) new TypefaceAnimatorEx.\u003CWaitPlay\u003Ec__Iterator0()
    {
      \u0024this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TypefaceAnimatorEx.\u003CPlayOnceCoroutine\u003Ec__Iterator1()
    {
      \u0024this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TypefaceAnimatorEx.\u003CPlayLoopCoroutine\u003Ec__Iterator2()
    {
      \u0024this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TypefaceAnimatorEx.\u003CPlayPingPongCoroutine\u003Ec__Iterator3()
    {
      \u0024this = this
    };
  }
  ...
  private void Modify(List<UIVertex> verts)
  {
    ...
    for (int index = 0; index < verts.Count; ++index)
    {
      if (index % 4 == 0)
      {
        ...
        if (this.usePosition)
        {
          Vector3 vector3 = Vector3.op_Addition(Vector3.op_Multiply(Vector3.op_Subtraction(this.positionTo, this.positionFrom), this.positionAnimationCurve.Evaluate(TypefaceAnimatorEx.SeparationRate(this.progress, currentCharacterNumber, this.characterNumber, this.positionSeparation))), this.positionFrom);
        ...
        if (this.useScale)
        {
          if (this.scaleSyncXY)
          {
            float num1 = (this.scaleTo - this.scaleFrom) * this.scaleAnimationCurve.Evaluate(TypefaceAnimatorEx.SeparationRate(this.progress, currentCharacterNumber, this.characterNumber, this.scaleSeparation)) + this.scaleFrom;
          ...
          else
          {
            ...
            float num4 = (this.scaleToY - this.scaleFromY) * this.scaleAnimationCurveY.Evaluate(TypefaceAnimatorEx.SeparationRate(this.progress, currentCharacterNumber, this.characterNumber, this.scaleSeparation)) + this.scaleFromY;
            // ISSUE: cast to a reference type
            // ISSUE: explicit reference operation
            // ISSUE: cast to a reference type
            // ISSUE: explicit reference operation
        ...
        if (this.useRotation)
        {
          float num1 = (this.rotationTo - this.rotationFrom) * this.rotationAnimationCurve.Evaluate(TypefaceAnimatorEx.SeparationRate(this.progress, currentCharacterNumber, this.characterNumber, this.rotationSeparation)) + this.rotationFrom;
          // ISSUE: cast to a reference type
          // ISSUE: explicit reference operation
          // ISSUE: cast to a reference type
          // ISSUE: explicit reference operation
        ...
        if (this.useColor)
        {
          color = Color.op_Addition(Color.op_Multiply(Color.op_Subtraction(this.colorTo, this.colorFrom), this.colorAnimationCurve.Evaluate(TypefaceAnimatorEx.SeparationRate(this.progress, currentCharacterNumber, this.characterNumber, this.colorSeparation))), this.colorFrom);
          vert1.color = vert2.color = vert3.color = vert4.color = (__Null) Color32.op_Implicit(color);
        }
        if (this.useAlpha)
        {
          float num = (this.alphaTo - this.alphaFrom) * this.alphaAnimationCurve.Evaluate(TypefaceAnimatorEx.SeparationRate(this.progress, currentCharacterNumber, this.characterNumber, this.alphaSeparation)) + this.alphaFrom;
