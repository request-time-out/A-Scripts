...
// Type: UploaderSystem.DownloadScene
...
namespace UploaderSystem
{
  public class DownloadScene : BaseLoader
  {
    ...
    private void Start()
    {
      ObservableExtensions.Subscribe<Unit>((IObservable<M0>) Observable.FromCoroutine((Func<IEnumerator>) (() => this.phpCtrl.GetBaseInfo(false)), false), (Action<M0>) (__ => {}), (Action<Exception>) (err => {}), (Action) (() => this.uiCtrl.changeSearchSetting = true));
