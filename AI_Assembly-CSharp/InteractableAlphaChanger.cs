...
internal class InteractableAlphaChanger : MonoBehaviour
{
  ...
  public InteractableAlphaChanger()
  {
    base.\u002Ector();
  }
  ...
  private void Awake()
  {
    if (!Object.op_Equality((Object) this.flagToggle, (Object) null))
      return;
    Debug.LogError((object) "flagToggle none", (Object) this);
  ...
  private void Start()
  {
    ...
    BoolReactiveProperty isInteract = new BoolReactiveProperty(((Selectable) this.flagToggle).get_interactable());
    ObservableExtensions.Subscribe<bool>((IObservable<M0>) isInteract, (Action<M0>) (isOn =>
    {
      ColorBlock colors = ((Selectable) this.flagToggle).get_colors();
    ...
    ObservableExtensions.Subscribe<Unit>((IObservable<M0>) ObservableTriggerExtensions.OnEnableAsObservable((Component) this), (Action<M0>) (_ => ((ReactiveProperty<bool>) isInteract).set_Value(((Selectable) this.flagToggle).get_interactable())));
    ObservableExtensions.Subscribe<bool>(Observable.DistinctUntilChanged<bool>((IObservable<M0>) Observable.Select<Unit, bool>((IObservable<M0>) ObservableTriggerExtensions.UpdateAsObservable((Component) this), (Func<M0, M1>) (_ => ((Selectable) this.flagToggle).get_interactable()))), (Action<M0>) (interactable => ((ReactiveProperty<bool>) isInteract).set_Value(interactable)));
  }
}
