...
public class DynamicBoneJob : MonoBehaviour
{
  ...
  private List<DynamicBoneJob.Particle> m_Particles;
  private JobHandle JobHandle;
  private NativeArray<DynamicBoneJob.CalcData> datas;

  public DynamicBoneJob()
  {
    base.\u002Ector();
  }
  ...
  private void OnDrawGizmosSelected()
  {
    ...
    {
      DynamicBoneJob.Particle particle1 = this.m_Particles[index];
      if (particle1.m_ParentIndex >= 0)
      {
        DynamicBoneJob.Particle particle2 = this.m_Particles[particle1.m_ParentIndex];
  ...
  public void UpdateParameters()
  {
    ...
    for (int index = 0; index < this.m_Particles.Count; ++index)
    {
      DynamicBoneJob.Particle particle = this.m_Particles[index];
  ...
  private void UpdateParticles1()
  {
    ...
    for (int index = 0; index < this.m_Particles.Count; ++index)
    {
      ...
      if (particle1.m_ParentIndex >= 0)
      {
        ...
        DynamicBoneJob.Particle particle2 = particle1;
  ...
  private void UpdateParticles2()
  {
    ...
    {
      DynamicBoneJob.Particle particle1 = this.m_Particles[index1];
      DynamicBoneJob.Particle particle2 = this.m_Particles[particle1.m_ParentIndex];
      float magnitude1;
      ...
      if ((double) num1 > 0.0 || (double) particle1.m_Elasticity > 0.0)
      {
        ...
        DynamicBoneJob.Particle particle3 = particle1;
        ...
        if ((double) num1 > 0.0)
        {
          ...
          {
            DynamicBoneJob.Particle particle4 = particle1;
  ...
  private void SkipUpdateParticles()
  {
    for (int index = 0; index < this.m_Particles.Count; ++index)
    {
      ...
      if (particle1.m_ParentIndex >= 0)
      {
        ...
        DynamicBoneJob.Particle particle4 = this.m_Particles[particle1.m_ParentIndex];
        float magnitude1;
        if (Object.op_Inequality((Object) particle1.m_Transform, (Object) null))
        {
        ...
        if ((double) num1 > 0.0)
        {
          ...
          if ((double) magnitude2 > (double) num2)
          {
            DynamicBoneJob.Particle particle5 = particle1;
  ...
  private void UpdateParticles2ForJobSystem()
  {
    ...
    for (int index = 1; index < this.m_Particles.Count; ++index)
    {
      ...
      if (this.m_Colliders != null)
      {
        ...
        NativeArray<Vector3> nativeArray1;
        ((NativeArray<Vector3>) ref nativeArray1).\u002Ector(count, (Allocator) 2, (NativeArrayOptions) 1);
        NativeArray<int> nativeArray2;
        ((NativeArray<int>) ref nativeArray2).\u002Ector(count, (Allocator) 2, (NativeArrayOptions) 1);
        ((NativeArray<Vector3>) ref nativeArray1).Dispose();
        ((NativeArray<int>) ref nativeArray2).Dispose();
      }
      if (this.m_FreezeAxis != DynamicBoneJob.FreezeAxis.None)
      {
        switch (this.m_FreezeAxis)
  ...
  private void UpdateParticles3ForIJob()
  {
    for (int index = 1; index < this.m_Particles.Count; ++index)
    {
      ...
      if (this.m_Colliders == null)
        ;
      Vector3 vector3_1 = Vector3.op_Subtraction(particle2.m_Position, particle1.m_Position);
      float magnitude2 = ((Vector3) ref vector3_1).get_magnitude();
      if ((double) magnitude2 > 0.0)
      {
        DynamicBoneJob.Particle particle3 = particle1;
        particle3.m_Position = Vector3.op_Addition(particle3.m_Position, Vector3.op_Multiply(vector3_1, (magnitude2 - magnitude1) / magnitude2));
      }
    }
  }
  ...
  {
    NativeArray<DynamicBoneJob.ParticleStruct> nativeArray1;
    ((NativeArray<DynamicBoneJob.ParticleStruct>) ref nativeArray1).\u002Ector(this.m_Particles.Count, (Allocator) 2, (NativeArrayOptions) 1);
    NativeArray<DynamicBoneJob.CollisionStruct> nativeArray2;
    ((NativeArray<DynamicBoneJob.CollisionStruct>) ref nativeArray2).\u002Ector(this.m_Colliders.Count, (Allocator) 2, (NativeArrayOptions) 1);
    for (int index = 0; index < this.m_Particles.Count; ++index)
    {
      DynamicBoneJob.Particle particle = this.m_Particles[index];
      ((NativeArray<DynamicBoneJob.ParticleStruct>) ref nativeArray1).set_Item(index, new DynamicBoneJob.ParticleStruct()
      {
    ...
    for (int index = 0; index < this.m_Colliders.Count; ++index)
    {
      ...
      if (!Object.op_Equality((Object) collider, (Object) null) && ((Behaviour) collider).get_enabled())
        ((NativeArray<DynamicBoneJob.CollisionStruct>) ref nativeArray2).set_Item(index, new DynamicBoneJob.CollisionStruct()
        {
    ...
    JobHandle jobHandle = IJobExtensions.Schedule<DynamicBoneJob.CalcJob4>((M0) new DynamicBoneJob.CalcJob4()
    {
      calcs = nativeArray1,
      colls = nativeArray2,
    ...
    for (int index = 0; index < this.m_Particles.Count; ++index)
      this.m_Particles[index].m_Position = ((NativeArray<DynamicBoneJob.ParticleStruct>) ref nativeArray1).get_Item(index).position;
    ((NativeArray<DynamicBoneJob.ParticleStruct>) ref nativeArray1).Dispose();
    ((NativeArray<DynamicBoneJob.CollisionStruct>) ref nativeArray2).Dispose();
  }

  private void OnDestroy()
  {
    ((JobHandle) ref this.JobHandle).Complete();
    if (!((NativeArray<DynamicBoneJob.CalcData>) ref this.datas).get_IsCreated())
      return;
    ((NativeArray<DynamicBoneJob.CalcData>) ref this.datas).Dispose();
  }
  ...
  public void CreateNativeArray()
  {
    ...
    if (this.m_Colliders.Count == 0)
      return;
    this.datas = new NativeArray<DynamicBoneJob.CalcData>(this.m_Colliders.Count, (Allocator) 4, (NativeArrayOptions) 1);
    for (int index = 0; index < this.m_Colliders.Count; ++index)
    {
      if (!Object.op_Equality((Object) this.m_Colliders[index], (Object) null))
        ((NativeArray<DynamicBoneJob.CalcData>) ref this.datas).set_Item(index, new DynamicBoneJob.CalcData()
        {
          direction = this.m_Colliders[index].m_Direction,
          center = this.m_Colliders[index].m_Center,
          bound = this.m_Colliders[index].m_Bound,
          radius = (this.m_Colliders[index] as DynamicBoneCollider).m_Radius,
          height = (this.m_Colliders[index] as DynamicBoneCollider).m_Height * 0.5f - (this.m_Colliders[index] as DynamicBoneCollider).m_Radius
        });
    }
  }
  ...
  private struct Parallel : IJobParallelFor
  {
    ...
    {
      DynamicBoneJob.CalcData calcData = ((NativeArray<DynamicBoneJob.CalcData>) ref this.calcs).get_Item(index);
      float num1 = calcData.radius * Mathf.Abs(calcData.lossyScale);
      Matrix4x4 identity = Matrix4x4.get_identity();
      ((Matrix4x4) ref identity).SetTRS(((NativeArray<Vector3>) ref this.positions).get_Item(index), ((NativeArray<Quaternion>) ref this.rotations).get_Item(index), ((NativeArray<Vector3>) ref this.lossyScales).get_Item(index));
      if ((double) calcData.height <= 0.0)
      {
        Vector3 vector3_1 = Vector4.op_Implicit(Matrix4x4.op_Multiply(identity, Vector4.op_Implicit(calcData.center)));
        if (calcData.bound == DynamicBoneColliderBase.Bound.Outside)
        {
          float num2 = num1 + this.particleRadius;
          float num3 = num2 * num2;
          Vector3 vector3_2 = Vector3.op_Subtraction(this.particlePosition, vector3_1);
          float sqrMagnitude = ((Vector3) ref vector3_2).get_sqrMagnitude();
          if ((double) sqrMagnitude > 0.0 && (double) sqrMagnitude < (double) num3)
          {
            float num4 = Mathf.Sqrt(sqrMagnitude);
            this.particlePosition = Vector3.op_Addition(vector3_1, Vector3.op_Multiply(vector3_2, num2 / num4));
            ((NativeArray<int>) ref this.isHits).set_Item(index, 1);
          }
          else
            ((NativeArray<int>) ref this.isHits).set_Item(index, 0);
        }
        else
        {
          float num2 = num1 - this.particleRadius;
      ...
      {
        Vector3 center1 = calcData.center;
        Vector3 center2 = calcData.center;
        switch (calcData.direction)
        {
          case DynamicBoneColliderBase.Direction.X:
            ref Vector3 local1 = ref center1;
            local1.x = (__Null) (local1.x - (double) calcData.height);
            ref Vector3 local2 = ref center2;
            local2.x = (__Null) (local2.x + (double) calcData.height);
            break;
          case DynamicBoneColliderBase.Direction.Y:
            ref Vector3 local3 = ref center1;
            local3.y = (__Null) (local3.y - (double) calcData.height);
            ref Vector3 local4 = ref center2;
            local4.y = (__Null) (local4.y + (double) calcData.height);
            break;
          case DynamicBoneColliderBase.Direction.Z:
            ref Vector3 local5 = ref center1;
            local5.z = (__Null) (local5.z - (double) calcData.height);
            ref Vector3 local6 = ref center2;
            local6.z = (__Null) (local6.z + (double) calcData.height);
            break;
        }
        Vector3 vector3_1 = Vector4.op_Implicit(Matrix4x4.op_Multiply(identity, Vector4.op_Implicit(center1)));
        Vector3 vector3_2 = Vector4.op_Implicit(Matrix4x4.op_Multiply(identity, Vector4.op_Implicit(center2)));
        if (calcData.bound == DynamicBoneColliderBase.Bound.Outside)
        {
          float num2 = num1 + this.particleRadius;
          float num3 = num2 * num2;
          Vector3 vector3_3 = Vector3.op_Subtraction(vector3_2, vector3_1);
          Vector3 vector3_4 = Vector3.op_Subtraction(this.particlePosition, vector3_1);
          float num4 = Vector3.Dot(vector3_4, vector3_3);
          if ((double) num4 <= 0.0)
          {
            ...
            if ((double) sqrMagnitude > 0.0 && (double) sqrMagnitude < (double) num3)
            {
              ...
              this.particlePosition = Vector3.op_Addition(vector3_1, Vector3.op_Multiply(vector3_4, num2 / num5));
              ((NativeArray<int>) ref this.isHits).set_Item(index, 1);
            }
            else
              ((NativeArray<int>) ref this.isHits).set_Item(index, 0);
          ...
          else
          {
            ...
            if ((double) num4 >= (double) sqrMagnitude1)
            {
              Vector3 vector3_5 = Vector3.op_Subtraction(this.particlePosition, vector3_2);
              float sqrMagnitude2 = ((Vector3) ref vector3_5).get_sqrMagnitude();
              if ((double) sqrMagnitude2 <= 0.0 || (double) sqrMagnitude2 >= (double) num3)
                return;
              float num5 = Mathf.Sqrt(sqrMagnitude2);
              this.particlePosition = Vector3.op_Addition(vector3_2, Vector3.op_Multiply(vector3_5, num2 / num5));
              ((NativeArray<int>) ref this.isHits).set_Item(index, 1);
            }
            else if ((double) sqrMagnitude1 > 0.0)
            {
              float num5 = num4 / sqrMagnitude1;
              Vector3 vector3_5 = Vector3.op_Subtraction(vector3_4, Vector3.op_Multiply(vector3_3, num5));
              float sqrMagnitude2 = ((Vector3) ref vector3_5).get_sqrMagnitude();
              if ((double) sqrMagnitude2 <= 0.0 || (double) sqrMagnitude2 >= (double) num3)
                return;
              float num6 = Mathf.Sqrt(sqrMagnitude2);
              ref DynamicBoneJob.Parallel local7 = ref this;
              local7.particlePosition = Vector3.op_Addition(local7.particlePosition, Vector3.op_Multiply(vector3_5, (num2 - num6) / num6));
              ((NativeArray<int>) ref this.isHits).set_Item(index, 1);
            }
            else
              ((NativeArray<int>) ref this.isHits).set_Item(index, 0);
        ...
        else
        {
          ...
          else
          {
            ...
            if ((double) num4 >= (double) sqrMagnitude1)
            {
              Vector3 vector3_5 = Vector3.op_Subtraction(this.particlePosition, vector3_2);
              float sqrMagnitude2 = ((Vector3) ref vector3_5).get_sqrMagnitude();
              if ((double) sqrMagnitude2 <= (double) num3)
                return;
              float num5 = Mathf.Sqrt(sqrMagnitude2);
              this.particlePosition = Vector3.op_Addition(vector3_2, Vector3.op_Multiply(vector3_5, num2 / num5));
              ((NativeArray<int>) ref this.isHits).set_Item(index, 1);
  ...
  private struct CalcJob4 : IJob
  {
    ...
    public void Execute()
    {
      for (int index = 1; index < ((NativeArray<DynamicBoneJob.ParticleStruct>) ref this.calcs).get_Length(); ++index)
      {
        DynamicBoneJob.ParticleStruct particleStruct1 = ((NativeArray<DynamicBoneJob.ParticleStruct>) ref this.calcs).get_Item(index);
        DynamicBoneJob.ParticleStruct particleStruct2 = ((NativeArray<DynamicBoneJob.ParticleStruct>) ref this.calcs).get_Item(particleStruct1.parentIndex);
        float magnitude1;
        ...
        if ((double) num1 > 0.0 || (double) particleStruct1.elasticity > 0.0)
        {
          ...
          ref DynamicBoneJob.ParticleStruct local1 = ref particleStruct1;
          ...
          if ((double) num1 > 0.0)
          {
            ...
            if ((double) magnitude2 > (double) num2)
            {
              ref DynamicBoneJob.ParticleStruct local2 = ref particleStruct1;
        ...
        if ((double) magnitude3 > 0.0)
        {
          ref DynamicBoneJob.ParticleStruct local = ref particleStruct1;
          local.position = Vector3.op_Addition(local.position, Vector3.op_Multiply(vector3_4, (magnitude3 - magnitude1) / magnitude3));
        }
        ((NativeArray<DynamicBoneJob.ParticleStruct>) ref this.calcs).set_Item(index, particleStruct1);
      }
    }

    private Vector3 CalcCollider(Vector3 _position, float _particleRadius)
    {
      for (int index = 0; index < ((NativeArray<DynamicBoneJob.CollisionStruct>) ref this.colls).get_Length(); ++index)
      {
        DynamicBoneJob.CollisionStruct collisionStruct = ((NativeArray<DynamicBoneJob.CollisionStruct>) ref this.colls).get_Item(index);
