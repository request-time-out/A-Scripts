...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody2D.SetAngularDrag
...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody2D
{
  ...
  public class SetAngularDrag : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      this.rigidbody2D.set_angularDrag(this.angularDrag.get_Value());
      return (TaskStatus) 2;
    }
    ...
    public virtual void OnReset()
    {
      ...
      this.angularDrag = (SharedFloat) 0.0f;
    }
  }
}
