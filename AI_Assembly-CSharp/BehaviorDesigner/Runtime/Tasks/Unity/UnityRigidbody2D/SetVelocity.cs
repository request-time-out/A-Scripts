...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody2D.SetVelocity
...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody2D
{
  ...
  public class SetVelocity : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      this.rigidbody2D.set_velocity(this.velocity.get_Value());
      return (TaskStatus) 2;
    }
    ...
    public virtual void OnReset()
    {
      ...
      this.velocity = (SharedVector2) Vector2.get_zero();
    }
  }
}
