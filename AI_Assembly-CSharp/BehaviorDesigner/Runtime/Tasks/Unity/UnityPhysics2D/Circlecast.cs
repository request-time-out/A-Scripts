...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityPhysics2D
{
  ...
  public class Circlecast : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      RaycastHit2D raycastHit2D = Physics2D.CircleCast(vector2_2, this.radius.get_Value(), vector2_1, (double) this.distance.get_Value() != -1.0 ? this.distance.get_Value() : float.PositiveInfinity, LayerMask.op_Implicit(this.layerMask));
