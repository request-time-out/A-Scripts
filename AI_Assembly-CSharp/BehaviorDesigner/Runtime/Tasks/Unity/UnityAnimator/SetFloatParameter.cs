...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityAnimator
{
  ...
  public class SetFloatParameter : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      float origVale = this.animator.GetFloat(this.hashID);
      this.animator.SetFloat(this.hashID, this.floatValue.get_Value());
      if (this.setOnce)
    ...
    public IEnumerator ResetValue(float origVale)
    {
      ...
      return (IEnumerator) new SetFloatParameter.\u003CResetValue\u003Ec__Iterator0()
      {
        origVale = origVale,
        \u0024this = this
      };
    ...
    public virtual void OnReset()
    {
      ...
      this.floatValue = (SharedFloat) 0.0f;
    }
  }
}
