...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityParticleSystem
{
  ...
  public class SetStartColor : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      ((ParticleSystem.MainModule) ref main).set_startColor(ParticleSystem.MinMaxGradient.op_Implicit(this.startColor.get_Value()));
      return (TaskStatus) 2;
    }
    ...
    public virtual void OnReset()
    {
      ...
      this.startColor = (SharedColor) Color.get_white();
    }
  }
}
