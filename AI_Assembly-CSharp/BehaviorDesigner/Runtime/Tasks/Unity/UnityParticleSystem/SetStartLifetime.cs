...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityParticleSystem
{
  ...
  public class SetStartLifetime : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      ((ParticleSystem.MainModule) ref main).set_startLifetime(ParticleSystem.MinMaxCurve.op_Implicit(this.startLifetime.get_Value()));
      return (TaskStatus) 2;
    }
    ...
    public virtual void OnReset()
    {
      ...
      this.startLifetime = (SharedFloat) 0.0f;
    }
  }
}
