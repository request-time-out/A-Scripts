...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityParticleSystem
{
  ...
  public class SetStartRotation : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      ((ParticleSystem.MainModule) ref main).set_startRotation(ParticleSystem.MinMaxCurve.op_Implicit(this.startRotation.get_Value()));
      return (TaskStatus) 2;
    }
    ...
    public virtual void OnReset()
    {
      ...
      this.startRotation = (SharedFloat) 0.0f;
    }
  }
}
