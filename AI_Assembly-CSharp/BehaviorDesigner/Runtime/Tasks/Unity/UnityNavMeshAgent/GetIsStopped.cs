...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityNavMeshAgent.GetIsStopped
...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityNavMeshAgent
{
  ...
  public class GetIsStopped : Action
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      this.storeValue.set_Value(this.navMeshAgent.get_isStopped());
      return (TaskStatus) 2;
    }
    ...
    public virtual void OnReset()
    {
      ...
      this.storeValue = (SharedBool) null;
    }
  }
}
