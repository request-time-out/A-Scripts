...
// Type: SuperScrollView.StaggeredGridView_LeftToRightDemoScript
  ...
  public class StaggeredGridView_LeftToRightDemoScript : MonoBehaviour
  {
      ...
      int index)
    {
      ...
      if (itemDataByIndex == null)
        return (LoopStaggeredGridViewItem) null;
      LoopStaggeredGridViewItem staggeredGridViewItem = listView.NewListViewItem("ItemPrefab1");
      ...
      float num = (float) (390.0 + (double) this.mItemWidthArrayForDemo[index % this.mItemWidthArrayForDemo.Length] * 10.0);
      staggeredGridViewItem.CachedRectTransform.SetSizeWithCurrentAnchors((RectTransform.Axis) 0, num);
    ...
    private void InitItemHeightArrayForDemo()
    {
      ...
      for (int index = 0; index < this.mItemWidthArrayForDemo.Length; ++index)
        this.mItemWidthArrayForDemo[index] = Random.Range(0, 20);
    }
