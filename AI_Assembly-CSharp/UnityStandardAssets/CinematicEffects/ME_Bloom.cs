...
// Type: UnityStandardAssets.CinematicEffects.ME_Bloom
...
namespace UnityStandardAssets.CinematicEffects
{
  ...
  {
    [SerializeField]
    public ME_Bloom.Settings settings;
    [SerializeField]
    [HideInInspector]
    ...
    {
      if (ME_ImageEffectHelper.IsSupported(this.shader, true, false, (MonoBehaviour) this))
        return;
