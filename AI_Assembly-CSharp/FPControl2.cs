...
public class FPControl2 : MonoBehaviour
{
  ...
  {
    if (Object.op_Inequality((Object) this._currentWeapon, (Object) null))
  ...
  public void Shoot()
  {
    ...
    if (!Physics.Raycast(this.myCamera.ScreenPointToRay(new Vector3((float) this.myCamera.get_pixelWidth() * 0.5f, (float) this.myCamera.get_pixelHeight() * 0.5f, 0.0f)), ref raycastHit))
      return;
    DungeonControl2 componentInParents = Utils.FindComponentInParents<DungeonControl2>(((Component) ((RaycastHit) ref raycastHit).get_collider()).get_transform());
    if (!Object.op_Inequality((Object) componentInParents, (Object) null))
      return;
    this._currentWeapon.Shoot(componentInParents, ((Component) this.myCamera).get_transform().get_position(), ((RaycastHit) ref raycastHit).get_point());
  }
}
