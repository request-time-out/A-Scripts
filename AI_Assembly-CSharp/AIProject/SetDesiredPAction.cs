...
// Type: AIProject.SetDesiredPAction
...
namespace AIProject
{
  ...
  public class SetDesiredPAction : AgentAction
  {
    ...
    public virtual void OnStart()
    {
      ...
      switch (Singleton<Manager.Map>.Instance.Simulator.Weather)
      {
        ...
        case Weather.Storm:
          ...
          {
            SetDesiredPAction.CreateList(agent, chunk.AppendActionPoints, actionPointList, this._eventType, true);
            ...
            if (Object.op_Equality((Object) this._destination, (Object) null))
            {
              ...
              SetDesiredPAction.CreateList(agent, chunk.ActionPoints, actionPointList, this._eventType, true);
              if (!actionPointList.IsNullOrEmpty<ActionPoint>())
              {
                SetDesiredPAction.NearestPoint(position, actionPointList, out this._destination);
                break;
              }
              break;
            }
      ...
      {
        actionPointList.Clear();
        SetDesiredPAction.CreateList(agent, chunk.AppendActionPoints, actionPointList, this._eventType, false);
        if (!actionPointList.IsNullOrEmpty<ActionPoint>())
          this._destination = actionPointList.GetElement<ActionPoint>(Random.Range(0, actionPointList.Count));
      }
      if (Object.op_Equality((Object) this._destination, (Object) null))
      {
        actionPointList.Clear();
        SetDesiredPAction.CreateList(agent, chunk.ActionPoints, actionPointList, this._eventType, false);
        if (!actionPointList.IsNullOrEmpty<ActionPoint>())
          SetDesiredPAction.NearestPoint(position, actionPointList, out this._destination);
      }
    ...
    {
      AgentActor agent = this.Agent;
      if (Object.op_Inequality((Object) agent.TargetInSightActionPoint, (Object) null) && agent.TargetInSightActionPoint.PlayerEventType.Contains(this._eventType))
        return (TaskStatus) 2;
      if (Object.op_Equality((Object) this._destination, (Object) null))
        return (TaskStatus) 1;
