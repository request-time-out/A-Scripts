...
// Type: AIProject.MoveSearchActor
  ...
  public class MoveSearchActor : AgentAction
  {
    ...
    public virtual TaskStatus OnUpdate()
    {
      ...
      if (agent.LivesActorCalc)
        return (TaskStatus) 3;
      return agent.SearchActorRoute.Count == 0 && Object.op_Equality((Object) agent.DestWaypoint, (Object) null) || !agent.LivesActorPatrol ? (TaskStatus) 2 : (TaskStatus) 3;
    }

    public virtual void OnEnd()
    {
      this.Agent.StopActorPatrol();
    }
