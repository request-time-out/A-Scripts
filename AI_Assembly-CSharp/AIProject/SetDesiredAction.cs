...
// Type: AIProject.SetDesiredAction
    ...
    public virtual void OnStart()
    {
      ...
      switch (Singleton<Manager.Map>.Instance.Simulator.Weather)
      {
        ...
        case Weather.Storm:
          ...
          {
            SetDesiredAction.CreateList(agent, chunk.AppendActionPoints, actionPointList, this._eventType, this._checkFollowType, true);
            ...
            if (Object.op_Equality((Object) this._destination, (Object) null))
            {
              ...
              SetDesiredAction.CreateList(agent, chunk.ActionPoints, actionPointList, this._eventType, this._checkFollowType, true);
              if (!actionPointList.IsNullOrEmpty<ActionPoint>())
              {
                SetDesiredAction.NearestPoint(position, actionPointList, out this._destination);
                break;
              }
              break;
            }
      ...
      {
        actionPointList.Clear();
        SetDesiredAction.CreateList(agent, chunk.AppendActionPoints, actionPointList, this._eventType, this._checkFollowType, false);
        if (!actionPointList.IsNullOrEmpty<ActionPoint>())
          this._destination = actionPointList.GetElement<ActionPoint>(Random.Range(0, actionPointList.Count));
      }
      if (Object.op_Equality((Object) this._destination, (Object) null))
      {
        actionPointList.Clear();
        SetDesiredAction.CreateList(agent, chunk.ActionPoints, actionPointList, this._eventType, this._checkFollowType, false);
        if (!actionPointList.IsNullOrEmpty<ActionPoint>())
          SetDesiredAction.NearestPoint(position, actionPointList, out this._destination);
      }
