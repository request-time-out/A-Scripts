...
// Type: PicoGames.QuickRopes.Link1
...
namespace PicoGames.QuickRopes
{
  ...
  public class Link1
  {
    ...
    public void ApplyJointSettings(float _anchorOffset)
    {
      if (Object.op_Equality((Object) this.joint, (Object) null))
      {
        this.joint = (CharacterJoint) this.gameObject.GetComponent<CharacterJoint>();
        if (Object.op_Equality((Object) this.joint, (Object) null))
          this.joint = (CharacterJoint) this.gameObject.AddComponent<CharacterJoint>();
      }
      ((UnityEngine.Joint) this.joint).set_anchor(new Vector3(0.0f, _anchorOffset, 0.0f));
      ((UnityEngine.Joint) this.joint).set_autoConfigureConnectedAnchor(true);
      ((UnityEngine.Joint) this.joint).set_axis(Vector3.get_up());
      this.joint.set_swingAxis(Vector3.get_right());
      CharacterJoint joint1 = this.joint;
      SoftJointLimit softJointLimit1 = (SoftJointLimit) null;
      ((SoftJointLimit) ref softJointLimit1).set_limit(-this.jointSettings.twistLimit);
      SoftJointLimit softJointLimit2 = softJointLimit1;
      joint1.set_lowTwistLimit(softJointLimit2);
      CharacterJoint joint2 = this.joint;
      SoftJointLimit softJointLimit3 = (SoftJointLimit) null;
      ((SoftJointLimit) ref softJointLimit3).set_limit(this.jointSettings.twistLimit);
      SoftJointLimit softJointLimit4 = softJointLimit3;
      joint2.set_highTwistLimit(softJointLimit4);
      CharacterJoint joint3 = this.joint;
      SoftJointLimit softJointLimit5 = (SoftJointLimit) null;
      ((SoftJointLimit) ref softJointLimit5).set_limit(this.jointSettings.swingLimit);
      SoftJointLimit softJointLimit6 = softJointLimit5;
      joint3.set_swing1Limit(softJointLimit6);
      CharacterJoint joint4 = this.joint;
      SoftJointLimit softJointLimit7 = (SoftJointLimit) null;
      ((SoftJointLimit) ref softJointLimit7).set_limit(this.jointSettings.swingLimit);
      SoftJointLimit softJointLimit8 = softJointLimit7;
      joint4.set_swing2Limit(softJointLimit8);
      ((UnityEngine.Joint) this.joint).set_breakForce(this.jointSettings.breakForce);
      ((UnityEngine.Joint) this.joint).set_breakTorque(this.jointSettings.breakTorque);
    }
    ...
    public void RemoveJoint()
    {
      ...
      this.joint = (CharacterJoint) null;
    }
